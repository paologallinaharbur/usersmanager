...
/*GetUser swagger:route POST /user/filter User getUser

Get a list of user respecting the filter. You can use one or more filters to narrow your queries, all filters will be added with an AND
